...
class UUTest(unittest.TestCase):
    ...
    def test_decode(self):
        inp = io.StringIO(encodedtextwrapped % (0o666, "t1"))
        out = io.StringIO()
        uu.decode(inp, out)
...
class UUStdIOTest(unittest.TestCase):
    ...
    def test_decode(self):
        sys.stdin = io.StringIO(encodedtextwrapped % (0o666, "t1"))
        sys.stdout = io.StringIO()
        uu.decode("-", "-")
...
#            pass
    ...
    def test_decodetwice(self):
        ...
        f = None
        try:
            f = io.StringIO(encodedtextwrapped % (0o644, self.tmpout))
